...
`POST` `https://cs571.org/rest/f24/hw11/register`
...
`POST` `https://cs571.org/rest/f24/hw11/messages?chatroom=CHATROOM_NAME`
...
`DELETE` `https://cs571.org/rest/f24/hw11/messages?id=MESSAGE_ID`
