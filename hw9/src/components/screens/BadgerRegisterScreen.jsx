    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputForm}>
        ...
        <TextInput
          ...
          value={confirmedPin}
          onChangeText={(text) => setConfirmedPin(text)}
        ></TextInput>
      </View>

      {pin.length === 0 ? (
        <Text style={{ color: "red", fontSize: 16 }}>Please enter a pin.</Text>
      ) : null}
      ...
      <View style={styles.buttonsContainer}>
        ...
        >
          <Text
            style={
              isDisabled
                ? { color: "#708090", fontSize: 15, fontWeight: "500" }
        ...
        <Pressable
          style={{ ...styles.button, width: 120, backgroundColor: "grey" }}
        >
